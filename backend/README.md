...
## Project Structure
    ...
    ├── testapiautosetting_115904  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_115904`
...
2. Clone this repo and `cd testapiautosetting_115904`
